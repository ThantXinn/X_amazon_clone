  ...
  return (
    <div className='bg-amazon_light h-11 flex items-center text-white max-lg:text-xs'>
      ...
      <div className='w-full h-full flex items-center text-sm max-lg:text-xs'>
        ...
        <div
          className={`text-amazon_yellow px-3 h-10 items-center border border-transparent hover:border-white duration-200 cursor-pointer rounded-sm max-lg:px-1 ${
            userinfoData ? "flex" : "hidden"
          }`}>
          <button
            onClick={() => {
